...
- **LDR**: a leitura é um valor bruto de 0–4095 (ADC de 12 bits do ESP32), não um valor calibrado em lux. Isso é suficiente para o desafio (comparação relativa de luminosidade).
