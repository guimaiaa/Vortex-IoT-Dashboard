...
//
// Configuracao no painel da Cloudflare:
// 1. Workers & Pages -> Create -> Create Worker
// 2. Cola este script no editor (formato ES module) e faz Deploy
// 3. No proprio Worker: aba Triggers -> Routes -> Add Route
//    Route: pulseorigin.com.br/iot-dashboard*
//    Zone: pulseorigin.com.br
//
// O front-end (Frontend/vite.config.js) ja gera os arquivos com o prefixo
